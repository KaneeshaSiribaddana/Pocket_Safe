...
import com.example.madproject.adapters.IncomesAdapter
...
class IncomesView : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("BudgetAK").child("incomes")
        // Remove the duplicate dialog.show() call
        // dialog.show()
